...
Widget build(BuildContext context) {
  return  MazowieckiePage();
}

class MazowieckiePage extends StatelessWidget {
   MazowieckiePage({
    super.key,
  });
...
final controller = TextEditingController();
 ...
 floatingActionButton: FloatingActionButton(
        onPressed: () {
          FirebaseFirestore.instance.collection('mazowieckiecities').add(
            {
