...
Widget build(BuildContext context) {
  return  MalopolskiePage();
}

class MalopolskiePage extends StatelessWidget {
   MalopolskiePage({
    super.key,
  });
...
final controller = TextEditingController();
 ...
 floatingActionButton: FloatingActionButton(
        onPressed: () {
          FirebaseFirestore.instance.collection('malopolskiecities').add(
            {
