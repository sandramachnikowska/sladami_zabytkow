...
Widget build(BuildContext context) {
  return DolnoslaskiePage();
}

class DolnoslaskiePage extends StatelessWidget {
  DolnoslaskiePage({
    super.key,
  });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          FirebaseFirestore.instance.collection('dolnoslaskiecities').add(
            {
