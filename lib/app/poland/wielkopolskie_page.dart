...
Widget build(BuildContext context) {
  return  WielkopolskiePage();
}

class WielkopolskiePage extends StatelessWidget {
  WielkopolskiePage({
    super.key,
  });
  ...
  Widget build(BuildContext context) {
   ...
   floatingActionButton: FloatingActionButton(
        onPressed: () {
          FirebaseFirestore.instance.collection('wielkopolskiecities').add(
            {
      ...
      body: StreamBuilder<QuerySnapshot>(
          stream: FirebaseFirestore.instance
              .collection('wielkopolskiecities')
              .snapshots(),
